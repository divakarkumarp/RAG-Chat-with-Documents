...
#to_parse_documents = ["./data/example.pdf", "./data/uber_sec.pdf"]
...
def load_or_parse_data():
    ...
    if os.path.exists(data_file):
        ...
        parsingInstructionUber10k = """The provided document is a Annual report filed by Uber Technologies, 
        ...
        llama_parse_documents = parser.load_data("./data/uber_sec.pdf")
...
def create_vector_database():
    ...
    #query = "what is the Adjusted Net Revenue 2019 Compared to 2018 ?"
